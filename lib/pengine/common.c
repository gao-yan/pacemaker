...
pe_cluster_option pe_opts[] = {
	...
	{ "batch-limit", NULL, "integer", NULL, "30", &check_number,
	  ...
	  "The \"correct\" value will depend on the speed and load of your network and cluster nodes." },
	{ "actions-limit", NULL, "integer", NULL, "0", &check_number,
	  "The number of jobs that the TE is allowed to execute in parallel on a node",
	  "Defaults to 0, the limit will be twice the number of CPU cores on DC. -1 means unlimited."},
	{ "migration-limit", NULL, "integer", NULL, "0", &check_number,
	  "The number of migration jobs that the TE is allowed to execute in parallel on a node",
	  "Defaults to 0, the limit will be half the number of CPU cores on DC. -1 means unlimited."},
